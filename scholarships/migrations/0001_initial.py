# Generated by Django 4.2.1 on 2023-05-11 04:11
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users', '0006_beneficiary_donor_institution_alter_user_idtype_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('donor_institution', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='donator', to='users.institution')),
                ('donor_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='donator', to='users.donor')),
